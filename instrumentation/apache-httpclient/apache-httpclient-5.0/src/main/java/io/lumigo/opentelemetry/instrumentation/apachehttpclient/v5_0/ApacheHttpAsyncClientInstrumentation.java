...
class ApacheHttpAsyncClientInstrumentation implements TypeInstrumentation {
  ...
  public static class WrappedFutureCallback<T> implements FutureCallback<T> {
    ...
    public void completed(T result) {
      ...
      ApacheHttpClientSingletons.instrumenter().end(context, httpRequest, getResponseFromHttpContext(), null);
    ...
    public void failed(Exception ex) {
      ...
      ApacheHttpClientSingletons.instrumenter().end(context, httpRequest, getResponseFromHttpContext(), ex);
