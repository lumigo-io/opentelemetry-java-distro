...
public class SessionInputBufferInstrumentation implements TypeInstrumentation {
  ...
  public ElementMatcher<ClassLoader> classLoaderOptimization() {
    return hasClassesNamed("org.apache.http.impl.io.SessionInputBufferImpl")
        .and(hasClassesNamed("software.amazon.awssdk.http.apache.ApacheHttpClient"));
  }

  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("org.apache.http.impl.io.SessionInputBufferImpl");
  }

  @Override
  public void transform(TypeTransformer transformer) {
    transformer.applyAdviceToMethod(
        isMethod().and(named("fillBuffer")).and(not(isAbstract())).and(takesArguments(0)),
        this.getClass().getName() + "$FillBufferAdvice");
  }

  @SuppressWarnings("unused")
  public static class FillBufferAdvice {
    ...
    public static void methodExit(
      ...
      // Append the payload to the object on the Context which can be accessed by
      // HttpPayloadExtractor
      ...
      PayloadBridge.appendResponsePayload(context, buffer, bodyStartPos, bufferLen);
    }
  }
}
