...
//      }
      ...
      if (handler instanceof io.opentelemetry.javaagent.instrumentation.netty.v4_0.server.HttpServerTracingHandler) {
        ourHandler = new HttpServerTracingHandler();
        // Client pipeline handlers
      } else if (handler instanceof io.opentelemetry.javaagent.instrumentation.netty.v4_0.client.HttpClientTracingHandler) {
