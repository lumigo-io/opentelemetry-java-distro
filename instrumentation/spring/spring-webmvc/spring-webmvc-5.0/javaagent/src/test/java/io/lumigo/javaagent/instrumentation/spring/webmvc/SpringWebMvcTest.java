...
public class SpringWebMvcTest {
  ...
  static void setUp() {
    ...
    SpringApplication app = new SpringApplication(SpringWebApp.class);
    ...
    context = app.run();
    serverUrl = "http://localhost:" + port + contextPath + "/";
  }
  ...
  void testHttpPost() {
    ...
    HttpRequest request =
        HttpRequest.newBuilder(URI.create(serverUrl + "greeting/post"))
